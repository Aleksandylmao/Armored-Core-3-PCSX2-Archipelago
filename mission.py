...
all_missions: tuple[Mission, ...] = (
	...
	Mission(0x12, "Eliminate the Bombers", Constants.REGION_FIRST_NATURE, 35, 0x19),
	# It's a bonus mission to Defend Water Processors
	...
	Mission(0x1A, "Destroy the AC", Constants.REGION_THIRD_DISTRICT1, 18, 0x0D),
	# Bonus Mission, Defend Personnel Convoy
	...
	Mission(0x23, "Defend Helicopter Crew", Constants.REGION_FIRST_NATURE, 16, 0x0D),
	# Bonus Mission, Prevent Capsule Theft
	...
	Mission(0x2B, "Distract Union Defenses", Constants.REGION_FIRST_SPECIAL, 33, 0x19),
	# Bonus Mission, Destroy Gun Emplacements
