...
def create_all_regions(world: AC3World) -> None:
    ...
    shop = Region(Constants.REGION_SHOP, world.player, world.multiworld)
    ...
    regions = [menu,shop,arena,mission_list,first_layer_district2,third_layer_industrial_research,third_layer_district1,
