...
class LegType:
    ...
    def __init__(self, name: str, needs_booster: bool):
        self.name = name
        self.built_in_booster = needs_booster


bipedal = LegType("Bipedal", False)
reverse_Joint = LegType("Reverse-Joint", False)
quadruped = LegType("Quadruped", False)
tank = LegType("Tank", True)
hover = LegType("Hover", True)
