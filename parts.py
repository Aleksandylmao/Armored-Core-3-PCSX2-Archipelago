...
class LegType:
	name: str
	built_in_booster: bool
	jump_function_provided: bool

	def __init__(self, name: str, built_in_booster: bool, jump_function_provided: bool):
		self.name = name
		self.built_in_booster = built_in_booster
		self.jump_function_provided = jump_function_provided


bipedal = LegType("Bipedal", False, True)
reverse_Joint = LegType("Reverse-Joint", False, True)
quadruped = LegType("Quadruped", False, True)
tank = LegType("Tank", True, False)
hover = LegType("Hover", True, False)


class Legs(Part):
	leg_type: LegType

	def __init__(self, _id: int, name: str, leg_type: LegType):
		super().__init__(_id, name)
		self.leg_type = leg_type


all_legs: tuple[Legs, ...] = (
	Legs(0x0C0, "CLM-01-EDF", bipedal),
	Legs(0x0C1, "MLM-MM/ORDER", bipedal),
	Legs(0x0C2, "CLM-02-SNSK", bipedal),
	Legs(0x0C3, "MLM-SS-ORC", bipedal),
	Legs(0x0C4, "MLM-MX-066", bipedal),
	Legs(0x0C5, "CLM-03-SRVT", bipedal),
	Legs(0x0C6, "CLL-01-FKST", bipedal),
	Legs(0x0C7, "MLL-SS/1001", bipedal),
	Legs(0x0C8, "MLL-MX/EDGE", bipedal),
	Legs(0x0C9, "CLL-HUESO", bipedal),
	Legs(0x0CA, "CLH-XV-MSGR", bipedal),
	Legs(0x0CB, "CMH-STIFF", bipedal),
	Legs(0x0CC, "MLH-MX/VOLAR", bipedal),
	Legs(0x0CD, "MLH-SS/RS", bipedal),
	Legs(0x0CE, "CLB-44-AKS", reverse_Joint),
	Legs(0x0CF, "MLB-SS/FLUID", reverse_Joint),
	Legs(0x0D0, "SLB-SOLID", reverse_Joint),
	Legs(0x0D1, "CLB-33-NMU", reverse_Joint),
	Legs(0x0D2, "MLB-MX/004", reverse_Joint),
	Legs(0x0D3, "MLF-RE/005", quadruped),
	Legs(0x0D4, "MLF-MX/KNOT", quadruped),
	Legs(0x0D5, "CLF-DS-SEV", quadruped),
	Legs(0x0D6, "CLF-D1-ILC", quadruped),
	Legs(0x0D7, "CLF-D2-ROG", quadruped),
	Legs(0x0D8, "CLC-03-MLKS", tank),
	Legs(0x0D9, "CLC-SHUT", tank),
	Legs(0x0DA, "MLC-RE/3003", tank),
	Legs(0x0DB, "MLC-TRIDENT", tank),
	Legs(0x0DC, "CLC-D3TA", tank),
	Legs(0x0DD, "MLR-RE/EGA", hover),
	Legs(0x0DE, "MLR-MX/QUAIL", hover),
	Legs(0x0DF, "MLR-SS/REM", hover),
	Legs(0x0E0, "MLR-MM/PETAL", hover),
	Legs(0x0E1, "CLR-00-MAK", hover),
)
...
all_arm_units_r: tuple[ArmUnitR, ...] = (
	...
	ArmUnitR(0x2C3, "CWG-SRF-80"),
	ArmUnitR(0x2C4, "MWG-SRF/60"),
	ArmUnitR(0x2C5, "MWG-MG/350"),
	ArmUnitR(0x2C6, "CWG-MG-500"),
	ArmUnitR(0x2C7, "MWG-MG/1000"),
	ArmUnitR(0x2C8, "CWG-HG-80"),
	ArmUnitR(0x2C9, "MWG-HG/100"),
	ArmUnitR(0x2CA, "CWG-BZ-50"),
	ArmUnitR(0x2CB, "CWG-BZ-30"),
	ArmUnitR(0x2CC, "MWG-SBZ/24"),
	ArmUnitR(0x2CD, "CWG-GS-72"),
	ArmUnitR(0x2CE, "CWG-GS-56"),
	ArmUnitR(0x2CF, "MWG-GS/54"),
	ArmUnitR(0x2D0, "CWGG-HM-60"),
	ArmUnitR(0x2D1, "CWGG-HR-66"),
	ArmUnitR(0x2D2, "CWGG-GR-12"),
	ArmUnitR(0x2D3, "MWG-KP/150"),
	ArmUnitR(0x2D4, "MWG-KP/100"),
	ArmUnitR(0x2D5, "MWG-XCW/90"),
	ArmUnitR(0x2D6, "MWG-XCB/75"),
	ArmUnitR(0x2D7, "MWG-KARASAWA"),
	ArmUnitR(0x2D8, "MWGG-XCG/20"),
	ArmUnitR(0x2D9, "KWB-SBROX"),
	ArmUnitR(0x2DA, "KWB-SBR01"),
	ArmUnitR(0x2DB, "KWB-MARS"),
)
...
all_arm_units_l: tuple[ArmUnitL, ...] = (
	...
	ArmUnitL(0x303, "KLB-TLS/SOL"),
	ArmUnitL(0x304, "MLB-MOONLIGHT"),
	ArmUnitL(0x305, "KWG-HZL50"),
	ArmUnitL(0x306, "KWG-HZL30"),
	ArmUnitL(0x307, "KWG-FTL450"),
	ArmUnitL(0x308, "CES-ES-0001"),
	ArmUnitL(0x309, "CES-ES-0101"),
	ArmUnitL(0x30A, "MES-ES/011"),
	ArmUnitL(0x30B, "KES-ES/MIRROR"),
)
